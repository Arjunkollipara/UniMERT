...
csd_path = r"F:\EVERYTHING\arjun folder\college files\4 fourth year\SEM 7\major_project(batch25)\datasets\CMU-MOSEI\CMU_MOSEI_TimestampedWords.csd"
output_dir = "data"
os.makedirs(output_dir, exist_ok=True)

with h5py.File(csd_path, "r") as f:
    covarep_group = f['words']
